/**
 * Create Food Modal Component
 * 
 * Modal dialog for creating new food with validation.
 */
...
export function CreateFoodModal({ isOpen, onClose, onSubmit, existingNames }: CreateFoodModalProps) {
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden animate-scale-in">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-lg font-bold text-slate-800">Thêm món mới</h2>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        <button
                            type="submit"
                            className="flex-1 px-4 py-3 rounded-xl bg-primary text-white font-semibold hover:bg-green-600 transition-colors shadow-lg shadow-primary/30"
                        >
                            Lưu món ăn
                        </button>
                    </div>
